...
get_ipython().run_line_magic('pip', 'install langchain==0.3.20 | tail -n 1')
get_ipython().run_line_magic('pip', 'install crewai==0.80.0 | tail -n 1')
get_ipython().run_line_magic('pip', 'install langchain-community==0.3.19 | tail -n 1')
get_ipython().run_line_magic('pip', 'install crewai-tools==0.38.0 | tail -n 1')
get_ipython().run_line_magic('pip', 'install databricks-sdk==0.57.0| tail -n 1')
...
# Suppress Pydantic and other deprecation/user warnings
...
import os 
os.environ['SERPER_API_KEY'] = "ef22fe458acb0b727eada730e9826bc3db285c1e"
